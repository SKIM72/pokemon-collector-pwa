...
scanner is open. Email authentication sessions are stored locally with Android
encrypted preferences, and scanned cards synchronize with the same Supabase
collection used by the PWA.
